    ...
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            Target("pack", DependsOn("init"), () =>
            {
                ...
                RunProcess("dotnet", $"pack ./AnsibleVault/AnsibleVault.csproj --no-build -c Release -p:Version={buildNumber}", "./..");
                RunProcess("dotnet", $"nuget push ./AnsibleVault/bin/Release/*.nupkg --no-symbols true -s https://api.nuget.org/v3/index.json -k {nugetOrgToken}", "./..");
            });
